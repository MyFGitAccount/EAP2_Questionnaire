...
### **Research Questionnaire: HKUSPACE Student Perception of Online Subscription Services**

**Section A: Usage and Experience**

1.  Have you ever used an online subscription service (e.g., for video/music, news, software, fitness, food boxes)?
    *   Yes
    *   No *(If "No," please proceed to Section C, Question 17)*

2.  What types of online subscription services have you used? *(Please select all that apply)*
...
3.  How many active online subscriptions do you currently pay for?
    *   0
    *   1-2
    *   3-4
    *   5 or more

4.  On average, what is your approximate total monthly spending on these services?
    *   Less than HKD $50
    *   HKD $51 - $150
    *   HKD $151 - $300
    *   More than HKD $300

**Section B: Perception and Evaluation**

5.  How important is "value for money" to you when deciding to subscribe to a service?
...
6.  How important is the flexibility to cancel a subscription at any time?
    *   Not at all important
    *   Slightly important
    *   Moderately important
    *   Very important
...
7.  To what extent do you agree with this statement: "The content or benefits provided by my subscriptions are worth their cost."
    *   Strongly disagree
    *   Disagree
    *   Neutral
    *   Agree
...
8.  How satisfied are you with the overall quality of the subscription services you use?
    *   Very dissatisfied
    *   Dissatisfied
    *   Neutral
    *   Satisfied
...
9.  How do you typically manage the payments for your multiple subscriptions?
    *   I track them manually (e.g., spreadsheet, notes)
    *   I rely on bank statements or email reminders
    *   I use a dedicated budgeting or subscription-tracking app
    *   I do not actively track them

10. Have you ever forgotten about a subscription and been charged for it without active use?
    *   Yes, this has happened multiple times
    *   Yes, this has happened once or twice
    *   No, this has never happened to me

11. To what extent do you feel subscription services make managing your personal finances more complicated?
...
12. What is your level of concern about your personal data privacy when using subscription services?
...
**Section C: General Attitudes (For All Respondents)**

13. What do you see as the main **advantage** of online subscription services? *(Please select the most significant one)*
    *   Convenience and constant access
    *   Access to a wide variety of content/features
    *   Cost-effectiveness compared to one-time purchases
    *   Personalization and recommendations
    *   No need for storage or physical clutter
    *   Other: ________________

14. What do you see as the main **disadvantage** of online subscription services? *(Please select the most significant one)*
    *   Recurring costs adding up
    *   Risk of forgetting and paying for unused services
    *   Feeling "locked in" or difficulty cancelling
    *   Ownership of nothing (no permanent access)
    *   Too many options leading to decision fatigue
    *   Other: ________________

15. How likely are you to try a new subscription service based on a free trial offer?
    *   Very unlikely
    *   Unlikely
    *   Neutral
    *   Likely
...
16. When considering a subscription, which factor influences you the most?
    *   Recommendations from friends/family
    *   Online reviews or influencer opinions
    *   Advertising or marketing materials
    *   The availability and terms of a free trial
    *   Brand reputation
    *   My own independent research

17. *(For both users and non-users)*: In general, what is your overall attitude towards the trend of more products and services moving to a subscription model?
    *   Very negative
    *   Somewhat negative
    *   Neutral
    *   Somewhat positive
...
**Section D: Demographic Information (For Classification Only)**
...
19. Which programme category are you currently enrolled in at HKUSPACE?
    *   Full-time Diploma / Associate Degree
    *   Part-time Degree / Associate Degree
    *   Foundation Diploma
    *   Other (Please specify): ________________

20. What is your average monthly personal spending allowance (for all personal expenses)?
    *   Less than HKD $3,000
    *   HKD $3,001 - $6,000
    *   HKD $6,001 - $10,000
